...
type UpdateSecretParams struct {
	...
	*/
	Payload *models.UpdateSecretByIDBody
...
// WithPayload adds the payload to the update secret params
func (o *UpdateSecretParams) WithPayload(payload *models.UpdateSecretByIDBody) *UpdateSecretParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the update secret params
func (o *UpdateSecretParams) SetPayload(payload *models.UpdateSecretByIDBody) {
	o.Payload = payload
}
