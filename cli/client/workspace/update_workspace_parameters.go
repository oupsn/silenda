...
type UpdateWorkspaceParams struct {
	...
	/* Payload.
	   ...
	   UpdateWorkspaceBody
	*/
	Payload *models.UpdateWorkspaceBody
...
// WithPayload adds the payload to the update workspace params
func (o *UpdateWorkspaceParams) WithPayload(payload *models.UpdateWorkspaceBody) *UpdateWorkspaceParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the update workspace params
func (o *UpdateWorkspaceParams) SetPayload(payload *models.UpdateWorkspaceBody) {
	o.Payload = payload
}
