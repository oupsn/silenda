...
type CreateWorkspaceParams struct {
	...
	/* Payload.
	   ...
	   CreateWorkspaceBody
	*/
	Payload *models.CreateWorkspaceBody
...
// WithPayload adds the payload to the create workspace params
func (o *CreateWorkspaceParams) WithPayload(payload *models.CreateWorkspaceBody) *CreateWorkspaceParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the create workspace params
func (o *CreateWorkspaceParams) SetPayload(payload *models.CreateWorkspaceBody) {
	o.Payload = payload
}
